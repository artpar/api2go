...
[![Join the chat at https://gitter.im/artpar/api2go](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/artpar/api2go?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
[![GoDoc](https://godoc.org/github.com/artpar/api2go?status.svg)](https://godoc.org/github.com/artpar/api2go)
[![Build Status](https://travis-ci.org/artpar/api2go.svg?branch=master)](https://travis-ci.org/artpar/api2go)
[![Coverage Status](https://coveralls.io/repos/github/artpar/api2go/badge.svg?branch=master)](https://coveralls.io/github/artpar/api2go?branch=master)
[![Go Report Card](https://goreportcard.com/badge/artpar/api2go)](https://goreportcard.com/report/artpar/api2go)
